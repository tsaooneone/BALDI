var ckbox = document.getElementsByClassName("ckbox");
		...
		function addprice(index,value){
			totle[index].innerHTML="$"+(price[index].getAttribute("data-price")*value);
			totle[index].setAttribute("data-totle",(price[index].getAttribute("data-price")*value));
		}
		//判斷商品信息前的複選框是否打勾
		function ischoose(){
			var totleprice=0;
